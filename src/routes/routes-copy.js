  ...
  "super-admin": {
    ...
    inventarios: {
      "/": {
        ...
        meta: { can: 'inventarios.view' },
      },
      crear: {
        path: 'super-admin/inventariosGestion/index.html',
        controller: gestionInventarios,
        meta: { can: 'inventarios.create', modal: true },
      },
      detalles: {
        path: 'super-admin/inventariosGestion/index.html',
        controller: gestionInventarios,
        meta: { can: 'inventarios.view', modal: true },
      },
      editar: {
        path: 'super-admin/inventariosGestion/index.html',
        controller: gestionInventarios,
        meta: { can: 'inventarios.update', modal: true },
      },
    },
    "tipos-elementos": {
      "/": {
